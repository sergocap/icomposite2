...
b==="api")return a(this).data("Jcrop");a(this).data("Jcrop").setOptions(b)}else this.tagName=="IMG"?a.Jcrop.Loader(this,function(){a(this).css({display:"block",visibility:"hidden"}),d=a.Jcrop(this,b),a.isFunction(c)&&c.call(d)}):(a(this).css({display:"block",visibility:"hidden"}),d=a.Jcrop(this,b),a.isFunction(c)&&c.call(d))}),this},a.Jcrop.Loader=function(b,c,d){function g(){f.complete?(e.unbind(".jcloader"),a.isFunction(c)&&c.call(f)):window.setTimeout(g,50)}var e=a(b),f=e[0];e.bind("load.jcloader",g).bind("error.jcloader",function(b){e.unbind(".jcloader"),a.isFunction(d)&&d.call(f)}),f.complete&&a.isFunction(c)&&(e.unbind(".jcloader"),c.call(f))},a.Jcrop.defaults={allowSelect:!0,allowMove:!0,allowResize:!0,trackDocument:!0,baseClass:"jcrop",addClass:null,bgColor:"black",bgOpacity:.6,bgFade:!1,borderOpacity:1,handleOpacity:.5,handleSize:null,aspectRatio:0,keySupport:!0,createHandles:["n","s","e","w","nw","ne","se","sw"],createDragbars:["n","s","e","w"],createBorders:["n","s","e","w"],drawBorders:!0,dragEdges
...
;
(function() {
  var destroy_jBox, get_next_id, get_previous_id;

  this.init_number_the_ajax_place_show = function() {
    return $('.ajax-place_show').each((function(_this) {
      return function(i, e) {
        return $(e).attr('data-id', i);
      };
    })(this));
  };

  this.init_ajax_place_show = function() {
    var myModal;
    myModal = null;
    $('.ajax-place_show').on('ajax:success', function(e, data) {
      var id, next_id, previous_id;
      myModal = new jBox('Modal', {
        width: '291px',
        height: '200px',
        onClose: destroy_jBox,
        content: data
      });
      myModal.open();
      id = $(this).data('id');
      ...
      return $('.place.show td.link.left').attr('data-target_id', previous_id);
    });
    return $(document.body).on('mouseup', '.place.show td.link', function() {
      var next_id, previous_id, target_id, target_place, target_url;
  ...
  destroy_jBox = function() {
    return $('.jBox-wrapper.jBox-Modal.jBox-Default').remove();
  };

}).call(this);
(function() {
  var adaptive_table, draw_net, set_line;

  this.init_image_upload_net = function() {
    var canvas, context, preview;
    $('.image_upload_button_net').on('click', function() {
      return $('.js-image_upload_net').click();
    });
    canvas = $('.js-canvas_net');
    context = canvas[0].getContext('2d');
    preview = $('.image_upload_preview_net');
    $('.set_place_size').on('click', function() {
      return draw_net(context);
    });
    return $('.js-image_upload_net').on('change', function(e) {
      var file, reader;
  ...
  draw_net = function(context) {
    var i, image_height, image_width, j, k, place_height, place_width, ref, ref1, ref2, ref3, results;
    ...
    for (i = j = 0, ref = image_height, ref1 = place_height; ref1 > 0 ? j <= ref : j >= ref; i = j += ref1) {
      set_line(context, 0, i, image_width, i);
    }
    results = [];
    for (i = k = 0, ref2 = image_width, ref3 = place_width; ref3 > 0 ? k <= ref2 : k >= ref2; i = k += ref3) {
      results.push(set_line(context, i, 0, i, image_height));
    }
    return results;
  };

  set_line = function(context, x1, y1, x2, y2) {
    context.beginPath();
  ...
  adaptive_table = function() {
    var ic, rel, table, table_height_new, table_height_old, table_width;
    ic = $('.ic_main');
    table = $('.js-table');
    ...
    return table.css('visibility', 'visible');
  };

}).call(this);
(function() {
  var hexToRgb, init_crop, init_svg, jcrop_handler, set_crop_preview, set_rgb;

  this.init_image_upload = function() {
    $(document.body).on('click', '.js-image_upload_button', function() {
      return $('.js-image_input').click();
    });
    return $(document.body).on('change', '.js-image_input', function(e) {
      var file, reader;
      file = $(this).prop('files')[0];
      if (file.type.split('/')[0] === 'image') {
        reader = new FileReader();
        reader.onload = function(e) {
          ...
          if ($(preview).height() > 400) {
            $('.jBox-content').css('display', 'block');
          }
          if ($(preview).height() <= 400) {
            $('.jBox-content').css('display', 'table-cell');
          }
          if ($(preview).height() <= 400) {
            return $('.jBox-content').css('vertical-align', 'middle');
          }
        };
        return reader.readAsDataURL(file);
      } else {
  ...
  init_crop = function(preview) {
    var JcropAPI, ratioH, ratioW, showCoords;
    preview.css({
      'height': '',
      'width': ''
    });
    ...
    showCoords = function(c) {
      ...
      return $('#place_crop_height').val(c.h);
    };
    preview.Jcrop({
    ...
    return $('.jcrop-holder').children().first().children().first().children().first().css('visibility', 'hidden');
  };

  set_crop_preview = function(c) {
    var cropping_image, h2, k, preview_img, preview_wrapper, w2, x2, y2;
  ...
  init_svg = function(preview) {
    var svg_handler, svg_image;
    ...
    return set_rgb(hexToRgb("333333"));
  };

  this.init_mini_color = function() {
    return $('.mini_colors_input').minicolors({
      inline: true,
      change: function(hex) {
        return set_rgb(hexToRgb(hex));
      }
    });
  };

  set_rgb = function(rgb) {
    ...
    return $('#place_b_component').attr('value', rgb.b * 5 / 255);
  };
...
(function() {
  $(function() {
    ...
    if ($('.js-image_upload_net').length) {
      init_image_upload_net();
    }
    if ($('.js-table').length) {
      init_table();
    }
    if ($('.ajax-place_new').length) {
      init_ajax_place_new();
    }
    return true;
  });
...
(function() {
  ...
  this.init_ajax_place_new = function() {
    return $('.ajax-place_new').on('ajax:success', function(e, data) {
      var myModal;
      myModal = new jBox('Modal', {
        width: '900px',
        height: '500px',
